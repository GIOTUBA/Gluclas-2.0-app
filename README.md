...
## 🔬 About the app
Gluclas 2.0 is a mobile application designed to assist clinicians and researchers during glucose clamp experiments, providing real-time visualization and support tools.
...
## ⚠️ Disclaimer
This application is intended for **research and educational purposes only** and is not certified as a medical device.
