...
* [Time handling and negative timestamps](#time-handling-and-negative-timestamps)
* [Timestamp handling during the experiment](#timestamp-handling-during-the-experiment)
* [GIR suggestion and investigator workflow](#gir-suggestion-and-investigator-workflow)
* [Experiment data and export](#experiment-data-and-export)
...
[📥 Download `Smoothed_OGTT_for_GLUCLAS2_example.csv`](https://raw.githubusercontent.com/TUO-USERNAME/TUA-REPOSITORY/main/examples/Smoothed_OGTT_for_GLUCLAS2_example.csv)
